...
internal class PPairToKotlinPair : ConverterFactory {
    override fun create(sourceType: PClassInfo<*>, targetType: Type): Optional<Converter<*, *>> {
        ...
        val pairType =
            Reflection.getExactSupertype(targetType, Pair::class.java) as ParameterizedType
        return Optional.of(
            ConverterImpl<Any, Any>(
                pairType.actualTypeArguments[0],
                pairType.actualTypeArguments[1]
            )
        )
    }
