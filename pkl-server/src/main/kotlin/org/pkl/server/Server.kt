...
class Server(private val transport: MessageTransport) : AutoCloseable {
    ...
    private fun handleCreateEvaluator(message: CreateEvaluatorRequest) {
        ...
        val baseResponse =
            CreateEvaluatorResponse(message.requestId, evaluatorId = null, error = null)
    ...
    private fun handleEvaluate(msg: EvaluateRequest) {
        val baseResponse =
            EvaluateResponse(msg.requestId, msg.evaluatorId, result = null, error = null)
        ...
        executor.execute {
            try {
                val resp =
                    evaluator.evaluate(ModuleSource.create(msg.moduleUri, msg.moduleText), msg.expr)
