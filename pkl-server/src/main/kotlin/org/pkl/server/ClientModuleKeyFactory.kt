...
internal class ClientModuleKeyFactory(
    ...
    companion object {
        private class ClientModuleKeyResolver(
            ...
            private val listResponses: MutableMap<URI, Future<List<PathElement>>> =
                ConcurrentHashMap()
                                ...
                                when (response) {
                                    is ReadModuleResponse -> {
                                        ...
                                        completeExceptionally(
                                            ProtocolException("unexpected response")
                                        )
                                    }
                                }
                            }
        ...
        private class ClientModuleKey(
            ...
            override fun listElements(
                securityManager: SecurityManager,
                baseUri: URI
            ): List<PathElement> = resolver.listElements(securityManager, baseUri)
