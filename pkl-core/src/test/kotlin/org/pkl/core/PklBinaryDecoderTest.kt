...
class PklBinaryDecoderTest {
  ...
  fun `decoding of unsupported pkl types fails`() {
    assertExceptionCauseMessageContains(
      byteArrayOf(0x94.toByte(), PklBinaryTypes.CODE_INTSEQ.code, 0x00, 0x04, 0x02),
      "Cannot decode IntSeq value",
    )
    assertExceptionCauseMessageContains(
      byteArrayOf(0x93.toByte(), PklBinaryTypes.CODE_CLASS.code) + strFoo + strFoo,
      "Cannot decode Class value",
    )
    assertExceptionCauseMessageContains(
      byteArrayOf(0x93.toByte(), PklBinaryTypes.CODE_TYPEALIAS.code) + strFoo + strFoo,
      "Cannot decode TypeAlias value",
    )
    assertExceptionCauseMessageContains(
      byteArrayOf(0x91.toByte(), PklBinaryTypes.CODE_FUNCTION.code),
  ...
  fun `decode unexpected eof`() {
    ...
    assertExceptionCauseMessageContains(
      byteArrayOf(0x92.toByte(), PklBinaryTypes.CODE_LIST.code, 0x91.toByte()),
      "Unexpected EOF",
    )
    // missing struct slot
    assertExceptionCauseMessageContains(
      byteArrayOf(0x92.toByte(), PklBinaryTypes.CODE_LIST.code),
      "Unexpected EOF",
    )
  }
  ...
  fun `decode invalid non-primitives`() {
    ...
    assertExceptionCauseMessageContains(
      byteArrayOf(0x93.toByte(), PklBinaryTypes.CODE_ELEMENT.code, 0x00, 0x00),
      "Unrecognized object code CODE_ELEMENT",
    )
  }
  ...
  fun `decode invalid object`() {
    // too few slots
    assertExceptionCauseMessageContains(
      byteArrayOf(0x91.toByte(), PklBinaryTypes.CODE_OBJECT.code),
      "Expected CODE_OBJECT structure to have at least 4 slots, found 1",
    )
    // blank class
    assertExceptionCauseMessageContains(
      byteArrayOf(0x94.toByte(), PklBinaryTypes.CODE_OBJECT.code, 0xa0.toByte()) + strFoo,
      "Unexpected blank object class name",
    )
    // blank module uri
    assertExceptionCauseMessageContains(
      byteArrayOf(0x94.toByte(), PklBinaryTypes.CODE_OBJECT.code) +
        strFoo +
    ...
    assertExceptionCauseMessageContains(
      byteArrayOf(0x94.toByte(), PklBinaryTypes.CODE_OBJECT.code) +
        strFoo +
        strFoo +
        byteArrayOf(0x91.toByte(), 0x93.toByte(), PklBinaryTypes.CODE_OBJECT.code),
      "Unrecognized member code CODE_OBJECT",
    )
  }
  ...
  fun `decode invalid units`() {
    assertExceptionCauseMessageContains(
      byteArrayOf(0x93.toByte(), PklBinaryTypes.CODE_DURATION.code) + doubleZero + strFoo,
      "Invalid Duration unit `foo`",
    )
    assertExceptionCauseMessageContains(
      byteArrayOf(0x93.toByte(), PklBinaryTypes.CODE_DATASIZE.code) + doubleZero + strFoo,
  ...
  fun `decode invalid types`() {
    assertExceptionCauseMessageContains(
      byteArrayOf(0x93.toByte(), PklBinaryTypes.CODE_CLASS.code, 0xa0.toByte()) + strFoo,
      "Unexpected blank class name",
    )
    assertExceptionCauseMessageContains(
      byteArrayOf(0x93.toByte(), PklBinaryTypes.CODE_CLASS.code) +
        strFoo +
        byteArrayOf(0xa0.toByte()),
      "Unexpected blank class module URI",
    )
    assertExceptionCauseMessageContains(
      byteArrayOf(0x93.toByte(), PklBinaryTypes.CODE_TYPEALIAS.code, 0xa0.toByte()) + strFoo,
      "Unexpected blank typealias name",
    )
    assertExceptionCauseMessageContains(
      byteArrayOf(0x93.toByte(), PklBinaryTypes.CODE_TYPEALIAS.code) +
        strFoo +
        byteArrayOf(0xa0.toByte()),
