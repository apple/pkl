 ...
 *
 * <p>MessagePack's Map type can represent sequence of key-value pairs.
 */
public interface MapValue extends Value {
   ...
   *
   * <p>Odd elements are keys. Next element of an odd element is a value corresponding to the key.
   *
   * <p>For example, if this value represents <code>{"k1": "v1", "k2": "v2"}</code>, this method
   * returns ["k1", "v1", "k2", "v2"].
   */
