 ...
 *
 * <p>MessagePack's Float type can represent IEEE 754 double precision floating point numbers
 * including NaN and infinity. This is same with Java's {@code double} type.
 *
