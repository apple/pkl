...
public abstract class ReadSuperPropertyNode extends ExpressionNode {
  ...
  @Specialization(
      guards = {"getObjectReceiver(frame) == receiver", "getOwner(frame) == initialOwner"})
  ...
  protected @Nullable Pair<VmObjectLike, ObjectMember> getPropertyAndOwner(
      VmObjectLike initialOwner) {
