...
@ImportStatic({Identifier.class, VmUtils.class})
...
public abstract class InvokeMethodVirtualNode extends AbstractInvokeMethodNode {
  ...
  @Specialization(
      guards = {"unresolvedTypeArgumentNodes == null", "receiverClass == cachedReceiverClass"})
  protected Object evalNoArgsCached(
      VirtualFrame frame,
      Object receiver,
      @SuppressWarnings("unused") VmClass receiverClass,
  ...
  @Specialization(
      guards = {
        ...
        "receiverClass == cachedReceiverClass"
      })
  ...
  @Specialization(replaces = {"evalNoArgsCached", "evalArgsCached"})
