...
public class ReadAmbiguousLocalityPropertyNode extends ExpressionNode {
  ...
  // shouldn't `replace()` because this same node can resolve to either a local or non-local
  // property depending on the receiver; see
  // pkl-core/src/test/files/LanguageSnippetTests/input/basic/localProperty5.pkl
  ...
  public Object executeGeneric(VirtualFrame frame) {
    return getUnderlying(frame).executeGeneric(frame);
  }
}
