...
val nativeTestImplementation: Configuration by configurations.getting {
  extendsFrom(configurations.testImplementation.get())
}

val nativeTestRuntimeOnly: Configuration by configurations.getting {
...
val buildNativeImageLibrary by tasks.registering {
  group = "build"
  val underlyingTask =
...
val buildSharedLibrary by
  tasks.registering(CCompile::class) {
    ...
    val objectFile = buildPklObjectFile.flatMap { task ->
...
val buildNativeTestC by tasks.registering {
