...
class JNATest {
  ...
  @Test
  fun `create evaluator, receive message, and close evaluator`() {
    ...
    assertThat(client.send(CloseEvaluator(evaluatorId))).isEqualTo(0)
    assertThat(client).hasSize(0)
  }
  ...
  private val ByteArray.debugRendering: String
