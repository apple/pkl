...
public enum NodeType {
  ...
  IF_HEADER(NodeKind.EXPR),
  IF_CONDITION(NodeKind.EXPR),
  IF_THEN_EXPR(NodeKind.EXPR),
  IF_ELSE_EXPR(NodeKind.EXPR),
  LET_EXPR(NodeKind.EXPR),
  LET_PARAMETER_DEFINITION(NodeKind.EXPR),
  LET_PARAMETER(NodeKind.EXPR),
