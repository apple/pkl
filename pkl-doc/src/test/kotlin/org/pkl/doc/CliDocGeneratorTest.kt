...
class CliDocGeneratorTest {
  companion object {
    ...
    private val actualOutputDir3: Path by lazy { baseActualOutputDir.resolve("run-3") }
    ...
    private fun generateDocs(): List<String> {
      ...
      // simulate running the doc generator again with old packages.
      actualOutputDir2.copyToRecursively(actualOutputDir3, followLinks = false)
      runDocGenerator(actualOutputDir3, cacheDir, listOf(URI("package://localhost:0/birds@0.5.0")))
