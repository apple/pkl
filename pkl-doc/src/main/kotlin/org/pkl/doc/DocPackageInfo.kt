...
data class DocPackageInfo(
                ...
                dependencies =
                    (module["dependencies"] as List<PObject>).map { dependency ->
                        PackageDependency(
                            ...
                            uri = null, // dependencies declared in a doc-package-info file do not
                            // have URIs
    ...
    data class PackageDependency(
        ...
        /**
         * The web URL of the source code for the depended-on package *version*. Must end with a
         * slash.
         */
        ...
        /**
         * The web URL of the Pkldoc page for the depended-on package *version*. Must end with a
         * slash. Only needs to be set if the depended-on package belongs to a different Pkldoc
         * website.
         */
