...
data class CliEvaluatorOptions(
     ...
     * placeholders can be used to map them to different output files. If multiple modules are
     * mapped to the same output file, their outputs are concatenated. Currently, the only available
     ...
     * - `%{outputFormat}` The requested output format. Only available if `outputFormat` is
     *   non-null.
     *
