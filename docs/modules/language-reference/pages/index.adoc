...
Packages can also be downloaded from a mirror. For more details, consult the <<mirroring_packages>> section of the language reference.
...
In situations where internet access is restricted, a mirror can be set up to allow use of packages that are hosted on the internet.
