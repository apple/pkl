...
favoritePigeon = (pigeon) {
  nameAndLifespanInIndex = "Bettie, \(lifespan)" // <6>
}

samePigeon = pigeon == favoritePigeon // <7>
----
...
<6> Our favorite pigeon should be indexed with her name!
<7> Objects that differ only in `hidden` property values are considered equal
