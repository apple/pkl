...
====
Default: (none) +
The file to write profiler output to. Omitting this option disables CPU profiling entirely. +

The CPU profiler writes output in https://github.com/google/pprof[pprof] format.
====
...
====
Default: 10 +
The sampling duration for the CPU sampler, in milliseconds.
====
