...
This command formats the given files according to Pkl's cannonical formatter.
...
[%collapsible]
====
Check if the inputs are properly formatted, printing the file name to stdout in case they are not.
