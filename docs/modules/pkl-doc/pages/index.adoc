...
:uri-pkl-doc-maven-module: {uri-maven-plugins-repo}/org/pkl/pkl-doc/{pkl-artifact-version}
...
The `pkl-doc` library is available {uri-pkl-doc-maven-module}[from Maven Central].
...
----
dependencies {
  compile "com.apple.pkl:pkl-doc:{pkl-artifact-version}"
}
----
