...
:uri-pkl-codegen-kotlin-maven-module: {uri-maven-plugins-repo}/org/pkl/pkl-codegen-kotlin/{pkl-artifact-version}
...
----
dependencies {
  compile "com.apple.pkl:pkl-codegen-kotlin:{pkl-artifact-version}"
}
----
