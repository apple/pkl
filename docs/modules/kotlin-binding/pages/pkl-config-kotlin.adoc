...
:uri-pkl-config-kotlin-maven-module: {uri-maven-plugins-repo}/org/pkl/pkl-config-kotlin/{pkl-artifact-version}
...
----
dependencies {
  compile "com.apple.pkl:pkl-config-kotlin:{pkl-artifact-version}"
}
----
