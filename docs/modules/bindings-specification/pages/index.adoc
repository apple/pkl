...
1. By spawning xref:pkl-cli:index.adoc#command-server[`pkl server`] as a subprocess, and communicating with it via STDIN/STDOUT.
2. By linking to the xref:libpkl:index.adoc[libpkl library].
