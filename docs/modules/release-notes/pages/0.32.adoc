...
* Cached packages can be written outside the cache dir (https://github.com/apple/pkl/pull/1683[#1683])
...
* Dependency notation allow path traversal past package root for local dependencies (https://github.com/apple/pkl/pull/1737([#1737])
...
* Remote packages can read local filesystem items by escaping local dependency roots (https://github.com/apple/pkl/security/advisories/GHSA-fgvf-hh2w-cxff[GHSA-fgvf-hh2w-cxff])
* Packages can be read/written outside the configured cache directory (https://github.com/apple/pkl/security/advisories/GHSA-87qh-25w9-mh34[GHSA-87qh-25w9-mh34])
