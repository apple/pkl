...
* Fixes an issue where `pkl format` adds an additional superfluous newline when writing formatted content to standard output (https://github.com/apple/pkl/issues/1346[#1346]).
