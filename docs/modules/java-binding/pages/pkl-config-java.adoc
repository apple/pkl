...
:uri-pkl-config-java-maven-module: {uri-maven-plugins-repo}/org/pkl/pkl-config-java-all/{pkl-artifact-version}
...
----
dependencies {
  implementation "com.apple.pkl:pkl-config-java-all:{pkl-artifact-version}"
}
----
