...
:uri-pkl-codgen-java-maven-module: {uri-maven-plugins-repo}/org/pkl/pkl-codegen-java/{pkl-artifact-version}
...
----
dependencies {
  compile "org.pkl.testMode.pkl:pkl-codegen-java:{pkl-artifact-version}"
}
----
