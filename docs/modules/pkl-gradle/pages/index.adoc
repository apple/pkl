...
:uri-pkl-gradle-maven-module: {uri-maven-plugins-repo}/org/pkl/pkl-gradle/{pkl-artifact-version}
...
----
plugins {
  id "com.apple.pkl" version "{pkl-artifact-version}"
}
----
...
* Input project directories are required
