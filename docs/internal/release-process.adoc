...
... It's okay if there are errors like `Unexpected HTTP status code 404 for external link https://pkl.apple.com/pkl/<new-version>-dev/...` because we do not publish docs for unreleased versions of Pkl.
